...
class TransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.fg_gate_multiscale = nn.ModuleList([
            nn.Conv1d(n_embd, 1, 1),
            nn.Conv1d(n_embd, 1, 3, padding=1),
            nn.Conv1d(n_embd, 1, 5, padding=2)
        ])
        self.fg_gate_fusion = nn.Conv1d(3, 1, 1)
    ...
    def forward(self, vid, txt, v_mask, pos_embd=None):
        ...
        return out, out_mask, txt, self_attn_txt
